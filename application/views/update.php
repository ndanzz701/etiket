                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
									  <div class="row form-group">
                                            ...
                                            <form action="<?php echo base_url()?>user/actionupdate/<?php echo $key->id?>" method="post">
                                        <div class="form-group">
                                            <label for="company" class=" form-control-label">Nama</label>
                                            <input type="text" id="company" placeholder="Masukan Nama Pelanggan" class="form-control" name="nama" value="<?php echo $key->nama?>">
                                        </div>
										 </div>
										  </div>
                                        <div class="form-group">
										 <div class="row form-group">
                                            ...
                                            <input type="text" id="vat" placeholder="1234567890" class="form-control" name="nik" value="<?php echo $key->nik?>">
											      </div>
										 </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col-8">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="city" placeholder="Masukan Jenis Kelamin" class="form-control" name="gender" value="<?php echo $key->gender?>">
                                                </div>
                                            </div>
                                              <div class="col-8">
                                                <div class="form-group">
                                                    <label for="city" class=" form-control-label">Telepon</label>
                                                    <input type="text" id="city" placeholder="Masukan No Telp" class="form-control" name="no_hp" value="<?php echo $key->no_hp?>">
                                                </div>
                                            </div>
